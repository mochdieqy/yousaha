        ...
        <div class="card border-0 shadow-sm">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('incomes.update', $income) }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('customer_id') is-invalid @enderror" 
                                    ...
                                    @foreach($customers as $customer)
                                        <option value="{{ $customer->id }}" {{ old('customer_id', $income->customer_id) == $customer->id ? 'selected' : '' }}>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" step="0.01" class="form-control @error('total') is-invalid @enderror" 
                                       id="total" name="total" value="{{ old('total', $income->total) }}" required readonly>
                        ...
                        <div class="row income-detail-row mb-3">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="number" step="0.01" class="form-control detail-amount" 
                                       name="details[{{ $index }}][amount]" value="{{ $detail->value }}" required>
                            </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <strong>Total Details: <span id="total-display">Rp {{ number_format($income->total, 0, ',', '.') }}</span></strong>
                        </div>
                    </div>
