        ...
        <div class="alert alert-info border-0 shadow-sm mb-4">
            <div class="d-flex align-items-center">
                ...
                <div>
                    ...
                    <br>
                    <small class="text-muted">Asset will be updated in this company's inventory</small>
                </div>
            </div>
        </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="date" 
                                           ...
                                           id="purchased_date" 
                                           name="purchased_date" 
                                           value="{{ old('purchased_date', $asset->purchased_date ? $asset->purchased_date->format('Y-m-d') : '') }}" 
                                           required>
