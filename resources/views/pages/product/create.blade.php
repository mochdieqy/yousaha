        ...
        <div class="alert alert-info border-0 shadow-sm mb-4">
            <div class="d-flex align-items-center">
                ...
                <div>
                    ...
                    <br>
                    <small class="text-muted">Product will be added to this company's inventory</small>
                </div>
            </div>
        </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select @error('type') is-invalid @enderror" 
                                        ...
                                        <option value="combo" {{ old('type') == 'combo' ? 'selected' : '' }}>
                                    ...
                                    <div class="mb-3">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" 
                                                   ...
                                                   value="1" 
                                                   {{ old('is_track_inventory') ? 'checked' : '' }}
