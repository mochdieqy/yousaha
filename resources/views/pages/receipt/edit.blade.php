            ...
            <form action="{{ route('receipts.update', $receipt) }}" method="POST" id="receiptForm">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('reference') is-invalid @enderror" 
                           id="reference" name="reference" value="{{ old('reference', $receipt->reference) }}" 
                ...
                <div class="mb-3">
                    ...
                    <div id="productsContainer">
                        ...
                        <div class="product-row row mb-2">
                            ...
                            <div class="col-md-3">
                                <span class="form-control-plaintext product-info">
                                    {{ $productLine->product->name }} - {{ $productLine->quantity }}
                                </span>
                            </div>
                            <div class="col-md-1">
                                @if($index > 0)
...
$(document).ready(function() {
    let productRowCount = {{ count($receipt->productLines) }};
