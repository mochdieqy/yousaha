                        ...
                        <select class="form-select @error('warehouse_id') is-invalid @enderror" 
                            ...
                            @foreach($warehouses as $warehouse)
                                <option value="{{ $warehouse->id }}" 
                                        {{ (old('warehouse_id', $stock->warehouse_id) == $warehouse->id) ? 'selected' : '' }}>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" class="form-control @error('quantity_total') is-invalid @enderror" 
                               ...
                               value="{{ old('quantity_total', $stock->quantity_total) }}" min="0" step="0.01" required>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" class="form-control @error('quantity_reserve') is-invalid @enderror" 
                               ...
                               value="{{ old('quantity_reserve', $stock->quantity_reserve) }}" min="0" step="0.01">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" class="form-control @error('quantity_incoming') is-invalid @enderror" 
                               ...
                               value="{{ old('quantity_incoming', $stock->quantity_incoming) }}" min="0" step="0.01">
                        ...
                        <div class="stock-detail-row row mb-3">
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="text" class="form-control" 
                                       ...
                                       value="{{ old("details.{$index}.code", $detail->code) }}" 
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="number" class="form-control" 
                                       ...
                                       value="{{ old("details.{$index}.cost", $detail->cost) }}" 
                                       min="0" step="0.01" placeholder="0.00">
                            </div>
                            <div class="col-md-2">
                                <label class="form-label">Reference</label>
                                <input type="text" class="form-control" 
                                       name="details[{{ $index }}][reference]" 
                                       value="{{ old("details.{$index}.reference", $detail->reference) }}" 
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="date" class="form-control" 
                                       ...
                                       value="{{ old("details.{$index}.expiration_date", $detail->expiration_date ? $detail->expiration_date->format('Y-m-d') : '') }}">
                            </div>
...
@section('script')
<script>
let detailRowIndex = {{ $stock->details->count() > 0 ? $stock->details->count() : 1 }};
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('editStockForm').addEventListener('submit', function(e) {
        ...
        if (reserved > total) {
            e.preventDefault();
            alert('Reserved quantity cannot be greater than total quantity.');
            return false;
        }
    });
