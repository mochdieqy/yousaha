...
<head>
    ...
    <title>Quotation - {{ $salesOrder->number }}</title>
    <style>
        body {
...
<body>
    <div class="header">
        ...
        <div class="quotation-info">
            ...
            <div class="quotation-number">{{ $salesOrder->number }}</div>
            <div class="quotation-date">Date: {{ $salesOrder->created_at->format('M d, Y') }}</div>
            <div class="quotation-date">Valid Until: {{ $salesOrder->deadline->format('M d, Y') }}</div>
        </div>
        <div class="clear"></div>
    </div>

    <div class="customer-section">
        <div class="section-title">CUSTOMER & WAREHOUSE INFORMATION</div>
    ...
    <div class="terms">
        ...
        <ul style="margin: 0; padding-left: 20px;">
            <li>This quotation is valid until {{ $salesOrder->deadline->format('M d, Y') }}</li>
            <li>Prices are subject to change without prior notice</li>
            <li>Payment terms: Net 30 days</li>
            <li>Delivery will be made from {{ $salesOrder->warehouse->name }}</li>
    ...
    <div class="footer">
        ...
        <p>For any questions regarding this quotation, please contact us.</p>
